...
# Default params
inp_dir = _config.OUT_PLACE + f'pb_noW2_d_major_subset/'
...
params = {
  'mutations': 'VISGDNGERIPYCDKSKL',
  'wt':        'AAFRGTEAQTSDSNENES',
  'wt_dots':   '...................',
}
...
def main():
  ...
  # No need to propose genotypes since we're only using the ground truth PacBio data here to compare to inference results from Illumina data
