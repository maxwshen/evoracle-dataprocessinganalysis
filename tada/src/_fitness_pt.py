...
'''
def test():
  test_fold = '/ahg/regevdata/projects/CRISPR-libraries/prj2/evolution/abe8e/src/truth/200408/'
  inp_fn = test_fold + 'pv_groundtruth_0.0pct_t5_p2.csv'
  ...
  # Munge
  df['Abbrev genotype'] = [_lib.full_to_abbrev(gt) for gt in df['Full genotype']]
